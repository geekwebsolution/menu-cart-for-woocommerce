...
if (!class_exists('mcfw_shortcode_settings')) {
    ...
    class mcfw_shortcode_settings
    {
        ...
        public function shortcode_callback(){
            ...
            <div class="mcfw_shortcode_input_wp">
                ...
                <div class="mcfw_shortcode_tooltip">
                    ...
                    <span class="mcfw_tooltiptext" id="mcfw_shortcodeTooltip"><?php _e('Copy to clipboard','menu-cart-for-woocommerce'); ?></span>
                </div>
            </div>
            <span class="mcfw-pro-icon"><i><?php _e('This shortcode is only available in','menu-cart-for-woocommerce'); ?> <a href="https://geekcodelab.com/wordpress-plugins/menu-cart-for-woocommerce-pro/" target="_blank" title="Buy Menu Cart For Woocommerce Pro"><?php _e('Menu Cart Pro.','menu-cart-for-woocommerce'); ?></a></i></span>
            <?php
        }
        ...
        public function flyout_checkbox_callback($args) { ?>
            ...
            <br>
            <span class="mcfw-pro-icon"><i><?php _e('Flyout option is only available in','menu-cart-for-woocommerce'); ?> <a href="https://geekcodelab.com/wordpress-plugins/menu-cart-for-woocommerce-pro/" target="_blank" title="Buy Menu Cart For Woocommerce Pro"><?php _e('Menu Cart Pro.','menu-cart-for-woocommerce'); ?></a></i></span>
            <?php
        }
        ...
        public function flyout_contents_radio_callback($args) {
            ...
            <span class="mcfw-pro-icon"><i><?php _e('These event options are only available in','menu-cart-for-woocommerce') ?> <a href="https://geekcodelab.com/wordpress-plugins/menu-cart-for-woocommerce-pro/" target="_blank" title="Buy Menu Cart For Woocommerce Pro"><?php _e('Menu Cart Pro.','menu-cart-for-woocommerce') ?></a></i></span>
            <?php
        }
